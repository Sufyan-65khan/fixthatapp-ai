# Troubleshooting Guide: Box Notifications Not Working

Box notifications not working is usually caused by account state, outdated app versions, network instability, or backend service issues. Use this guide to isolate the root cause quickly.
...
Q: Why did Box suddenly start showing notifications not working today?
