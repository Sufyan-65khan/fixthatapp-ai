# Troubleshooting Guide: Dropbox Account Locked

Dropbox account locked is usually caused by account state, outdated app versions, network instability, or backend service issues. Use this guide to isolate the root cause quickly.
...
Q: Why did Dropbox suddenly start showing account locked today?
