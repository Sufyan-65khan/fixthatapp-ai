# Troubleshooting Guide: Genshin Impact Connection Timeout

Genshin Impact connection timeout is usually caused by account state, outdated app versions, network instability, or backend service issues. Use this guide to isolate the root cause quickly.
...
Q: Why did Genshin Impact suddenly start showing connection timeout today?
