# Troubleshooting Guide: CapCut Sync Not Working

CapCut sync not working is usually caused by account state, outdated app versions, network instability, or backend service issues. Use this guide to isolate the root cause quickly.
...
Q: Why did CapCut suddenly start showing sync not working today?
