# Troubleshooting Guide: PUBG Mobile Login Not Working

PUBG Mobile login not working is usually caused by account state, outdated app versions, network instability, or backend service issues. Use this guide to isolate the root cause quickly.
...
Q: Why did PUBG Mobile suddenly start showing login not working today?
