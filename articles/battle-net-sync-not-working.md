# Troubleshooting Guide: Battle.net Sync Not Working

Battle.net sync not working is usually caused by account state, outdated app versions, network instability, or backend service issues. Use this guide to isolate the root cause quickly.
...
Q: Why did Battle.net suddenly start showing sync not working today?
