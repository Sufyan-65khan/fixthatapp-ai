# Troubleshooting Guide: Genshin Impact Sync Not Working

Genshin Impact sync not working is usually caused by account state, outdated app versions, network instability, or backend service issues. Use this guide to isolate the root cause quickly.
...
Q: Why did Genshin Impact suddenly start showing sync not working today?
