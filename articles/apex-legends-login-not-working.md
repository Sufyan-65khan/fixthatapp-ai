# Troubleshooting Guide: Apex Legends Login Not Working

Apex Legends login not working is usually caused by account state, outdated app versions, network instability, or backend service issues. Use this guide to isolate the root cause quickly.
...
Q: Why did Apex Legends suddenly start showing login not working today?
