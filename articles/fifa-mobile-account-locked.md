# Troubleshooting Guide: FIFA Mobile Account Locked

FIFA Mobile account locked is usually caused by account state, outdated app versions, network instability, or backend service issues. Use this guide to isolate the root cause quickly.
...
Q: Why did FIFA Mobile suddenly start showing account locked today?
