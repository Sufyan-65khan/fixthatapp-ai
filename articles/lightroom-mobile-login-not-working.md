# Troubleshooting Guide: Lightroom Mobile Login Not Working

Lightroom Mobile login not working is usually caused by account state, outdated app versions, network instability, or backend service issues. Use this guide to isolate the root cause quickly.
...
Q: Why did Lightroom Mobile suddenly start showing login not working today?
