# Troubleshooting Guide: EA App Sync Not Working

EA App sync not working is usually caused by account state, outdated app versions, network instability, or backend service issues. Use this guide to isolate the root cause quickly.
...
Q: Why did EA App suddenly start showing sync not working today?
