# Troubleshooting Guide: Asana Account Locked

Asana account locked is usually caused by account state, outdated app versions, network instability, or backend service issues. Use this guide to isolate the root cause quickly.
...
Q: Why did Asana suddenly start showing account locked today?
