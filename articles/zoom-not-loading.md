# Troubleshooting Guide: Zoom Not Loading

Zoom not loading is usually caused by account state, outdated app versions, network instability, or backend service issues. Use this guide to isolate the root cause quickly.
...
Q: Why did Zoom suddenly start showing not loading today?
